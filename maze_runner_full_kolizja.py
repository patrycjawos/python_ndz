...
alien = Actor('alien', anchor=('center', 'center'), midleft=(30,HEIGHT/2))

alien.coords = alien.center
...
def update():
    ...
    for i in lista_zderzen:
        if alien.colliderect(sciany[i]):
            alien.pos = alien.coords

    alien.coords = alien.pos
